...
class Binary
{
     ...
     Binary (int sz)
     {
          if (sz <= 0)
          {
               throw "Length of the binary can't be less than 1";
          }
          this.length = sz;
     }
     ...
     Binary from_num (int number)
     {
          ...
          {
               throw "Number greater than " + this.length.toString() + " bits";
          }
          this.value = number;
          return this;  
     }
     ...
     Binary fromString(String s)
     {
          ...
          for(int i = 0; i < s.length; i++)
          {
               ...
               {
                    throw "String not a binary chain";
               }
          }
          value = p;
          return this;
     ...
     String toStringHexfill()
     {
          
          String r = this.toStringHex();
     ...
     String SubString(int ini,int end)
     {
          String s = this.toStringfill();
          String r = '';
          if(end > this.length || ini < 0)
          {
               throw "ini and end must be grether than 0 and less than " + this.length.toString();
          }
...
class Hex
{
     ...
     Hex (int sz)
     {
          if (sz <= 0)
          {
               throw "Length of the Hex can't be less than 1";
          }
          this.length = sz;
     }
